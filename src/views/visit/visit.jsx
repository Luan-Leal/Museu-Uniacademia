...
const Visit = () => {
  return (
    ...
    <div className="guia-paragrafo">
        <p>Seguindo as indicações da Prefeitura de Juiz de Fora (PJF), a partir desta quarta-feira, dia 8 de junho, volta a ser obrigatório o uso de máscaras em instituições <br/> de ensino. Logo, a partir dessa data, será exigido o uso de máscaras no UniAcademia, Colégio Academia e o Museu Universitário Academia. <br/> Isso vale para as salas de aula, laboratórios, banheiros, corredores e qualquer outro ambiente dos campus.
        </p>
